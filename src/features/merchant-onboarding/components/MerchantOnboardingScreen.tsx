...
import { MerchantOnboardingScreenProps, StripeConnectAccount } from '../types';

const MerchantOnboardingScreen: React.FC<MerchantOnboardingScreenProps> = ({
  account,
  loading,
